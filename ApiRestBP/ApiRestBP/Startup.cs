...
namespace ApiRestBP
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<DbBPContext>(options =>
            ...
            services.AddScoped<IMovimientoRepositorio, MovimientoRepositorio>();
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ApiRestBP", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ApiRestBP v1"));
            }
